...
#define BGFX_CAPS_DRAW_INDIRECT_COUNT             (0x0000000000000020) //!< Draw indirect with indirect count is supported.
#define BGFX_CAPS_FRAGMENT_DEPTH                  (0x0000000000000040) //!< Fragment depth is available in fragment shader.
#define BGFX_CAPS_FRAGMENT_ORDERING               (0x0000000000000080) //!< Fragment ordering is available in fragment shader.
#define BGFX_CAPS_GRAPHICS_DEBUGGER               (0x0000000000000100) //!< Graphics debugger is present.
#define BGFX_CAPS_HDR10                           (0x0000000000000200) //!< HDR10 rendering is supported.
#define BGFX_CAPS_HIDPI                           (0x0000000000000400) //!< HiDPI rendering is supported.
#define BGFX_CAPS_IMAGE_RW                        (0x0000000000000800) //!< Image Read/Write is supported.
#define BGFX_CAPS_INDEX32                         (0x0000000000001000) //!< 32-bit indices are supported.
#define BGFX_CAPS_INSTANCING                      (0x0000000000002000) //!< Instancing is supported.
#define BGFX_CAPS_OCCLUSION_QUERY                 (0x0000000000004000) //!< Occlusion query is supported.
#define BGFX_CAPS_PRIMITIVE_ID                    (0x0000000000008000) //!< PrimitiveID is available in fragment shader.
#define BGFX_CAPS_RENDERER_MULTITHREADED          (0x0000000000010000) //!< Renderer is on separate thread.
#define BGFX_CAPS_SWAP_CHAIN                      (0x0000000000020000) //!< Multiple windows are supported.
#define BGFX_CAPS_TEXTURE_BLIT                    (0x0000000000040000) //!< Texture blit is supported.
#define BGFX_CAPS_TEXTURE_COMPARE_LEQUAL          (0x0000000000080000) //!< Texture compare less equal mode is supported.
...
#define BGFX_CAPS_TEXTURE_2D_ARRAY                (0x0000000001000000) //!< 2D texture array is supported.
#define BGFX_CAPS_TEXTURE_3D                      (0x0000000002000000) //!< 3D textures are supported.
#define BGFX_CAPS_TRANSPARENT_BACKBUFFER          (0x0000000004000000) //!< Transparent back buffer supported.
#define BGFX_CAPS_VERTEX_ATTRIB_HALF              (0x0000000008000000) //!< Vertex attribute half-float is supported.
#define BGFX_CAPS_VERTEX_ATTRIB_UINT10            (0x0000000010000000) //!< Vertex attribute 10_10_10_2 is supported.
#define BGFX_CAPS_VERTEX_ID                       (0x0000000020000000) //!< Rendering with VertexID only is supported.
#define BGFX_CAPS_VIEWPORT_LAYER_ARRAY            (0x0000000040000000) //!< Viewport layer is available in vertex shader.
